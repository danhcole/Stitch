...
{
for (((struct stch_rangeInfo_0 *)vars)->j = 0 ; ((struct stch_rangeInfo_0 *)vars)->j < 10 ; ((struct stch_rangeInfo_0 *)vars)->j = ((struct stch_rangeInfo_0 *)vars)->j + 1) {
...
{
for (((struct stch_rangeInfo_1 *)vars)->j = 0 ; ((struct stch_rangeInfo_1 *)vars)->j < 10 ; ((struct stch_rangeInfo_1 *)vars)->j = ((struct stch_rangeInfo_1 *)vars)->j + 1) {
for (((struct stch_rangeInfo_1 *)vars)->k = 0 ; ((struct stch_rangeInfo_1 *)vars)->k < 10 ; ((struct stch_rangeInfo_1 *)vars)->k = ((struct stch_rangeInfo_1 *)vars)->k + 1) {
...
int thread_0 = 0;
for(i = 0;i < 10;i = i+10/NUMTHREADS) {
...
if((i + 2*(10/NUMTHREADS)) > 10) {
info_0[thread_0].end = 10;
i = 10;
}
else {
info_0[thread_0].end = i + 10/NUMTHREADS;
}
...
if((i + 2*(10/NUMTHREADS)) > 10) {
info_1[thread_1].end = 10;
i = 10;
}
else {
info_1[thread_1].end = i + 10/NUMTHREADS;
}
